...
compile-deps:
	...
	@$(WITH_ENV) pip-compile -U requires/requirements.in requires/postgres.in requires/mysql.in requires/redis.in requires/influxdb.in requires/dev.in --output-file requirements.txt
